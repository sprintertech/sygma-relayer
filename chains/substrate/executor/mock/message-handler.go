...
// Source: ./chains/substrate/executor/message-handler.go
...
func (mr *MockBlockFetcherMockRecorder) GetBlock(blockHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBlock", reflect.TypeOf((*MockBlockFetcher)(nil).GetBlock), blockHash)
}

// GetFinalizedHead mocks base method.
func (m *MockBlockFetcher) GetFinalizedHead() (types.Hash, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBlockFetcherMockRecorder) GetFinalizedHead() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFinalizedHead", reflect.TypeOf((*MockBlockFetcher)(nil).GetFinalizedHead))
}
